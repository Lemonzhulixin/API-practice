      ...
      if os.path.exists(json_results):#判断excel文件是否存在
            ...
            while a < len(jsonData):
                  try:  # 判断是否有异常的请求
                        ...
                        if testResult == "OK" : #判断运行结果是pass or # failed
                              newWs.write(a, 0, apiName)
                              newWs.write(a, 1, requestUrl)
                              newWs.write(a, 2, requestMethod)
                              newWs.write(a, 3, responseTime)
                              newWs.write(a, 4, statusCode)
                              newWs.write(a, 5, testResult)
                        else:
                              newWs.write(a, 0, apiName)
                              newWs.write(a, 1, requestUrl)
                              newWs.write(a, 2, requestMethod)
                        ...
                        newWs.write(a, 1, requestUrl)
                        newWs.write(a, 2, requestMethod)
                        newWs.write(a, 5, "Request Error")
                        newWs.write(a, 6, requestError)
            ...
            while a < len(jsonData):
                  try:
                        ...
                        if testResult == "OK":
                              ws.write(a, 0, apiName)
                              ws.write(a, 1, requestUrl)
                              ws.write(a, 2, requestMethod)
                              ws.write(a, 3, responseTime)
                              ws.write(a, 4, statusCode)
                              ws.write(a, 5, testResult)
                        else:
                              ws.write(a, 0, apiName)
                              ws.write(a, 1, requestUrl)
                              ws.write(a, 2, requestMethod)
                        ...
                        ws.write(a, 1, requestUrl)
                        ws.write(a, 2, requestMethod)
                        ws.write(a, 5, "Request Error")
                        ws.write(a, 6, requestError)
                        print(apiName, requestError)
                        a =a + 1
            else:
